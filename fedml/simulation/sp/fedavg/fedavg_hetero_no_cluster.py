...
class FedAvgAPI(object):
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            client_indexes = self._client_sampling(
                round_idx, self.client_total  # self.args.client_num_in_total
                , self.args.client_num_per_round
            )
            logging.info("client_indexes = " + str(client_indexes))

            client_type_dict = {
                51: ['M', 'M', 'M', 'L', 'H', 'M', 'L', 'M', 'M', 'H', 'M', 'L', 'M', 'M', 'M', 'H', 'M', 'L', 'L', 'M',
                     'M', 'M',
                     'M', 'M', 'L', 'M', 'L', 'H', 'M', 'M', 'H', 'M', 'L', 'L', 'H', 'M', 'L', 'M', 'H', 'M', 'L', 'M',
                     'M', 'H',
                     'L', 'L', 'H', 'H', 'L', 'L'],
                101: ['M', 'L', 'H', 'M', 'L', 'L', 'H', 'L', 'M', 'L', 'M', 'L', 'L', 'H', 'H', 'M',
                      'M', 'M', 'M', 'H', 'M', 'M', 'H', 'L', 'M', 'M', 'H', 'L', 'L', 'L', 'M', 'L', 'L', 'M', 'M',
                      'M',
                      'H', 'M', 'M', 'L', 'H', 'M', 'M', 'M', 'H', 'H', 'H', 'M', 'M', 'H', 'L', 'M', 'H',
                      'M', 'M', 'M', 'H', 'M', 'M', 'M', 'H', 'M', 'M', 'M', 'L', 'L', 'M', 'L', 'H', 'L', 'H', 'M',
                      'M',
                      'L', 'L', 'M', 'M', 'L', 'L', 'L', 'M', 'M', 'L', 'M', 'M', 'M', 'M', 'H', 'L', 'L', 'L', 'M',
                      'M',
                      'L', 'H', 'L', 'M', 'M', 'M', 'M']}

            dev_info = client_type_dict[self.global_rounds]

            dev_epoch = {'L': 1, 'M': 3, 'H': 5}
            ...
            for client_idx in client_indexes:
                ...
                # round=0
                # logging.info(client_indexes[idx])

                for i in range(dev_epoch[dev_info[client_idx]]):
                    # logging.info(round)
                    # round+=1
                    # update dataset
                    ...
                    mlops.event("train", event_started=True, event_value="{}_{}".format(str(round_idx), str(client_idx)))
                    w, l = client[client_idx].train(copy.deepcopy(w_global))
                    #self.loss_dict[client_idx].append(l)
                    mlops.event("train", event_started=False, event_value="{}_{}".format(str(round_idx), str(client_idx)))
    ...
    def _client_sampling(self, round_idx, client_num_in_total, client_num_per_round):
        ...
        client_type_dict={51:['M', 'M', 'M', 'L', 'H', 'M', 'L', 'M', 'M', 'H', 'M', 'L', 'M', 'M', 'M', 'H', 'M', 'L', 'L', 'M',
                    'M', 'M',
                    'M', 'M', 'L', 'M', 'L', 'H', 'M', 'M', 'H', 'M', 'L', 'L', 'H', 'M', 'L', 'M', 'H', 'M', 'L', 'M',
                    'M', 'H',
                    'L', 'L', 'H', 'H', 'L', 'L'],
                          101:['M', 'L', 'H', 'M', 'L', 'L', 'H', 'L', 'M', 'L', 'M', 'L', 'L', 'H', 'H', 'M',
                    'M', 'M', 'M', 'H', 'M', 'M', 'H', 'L', 'M', 'M', 'H', 'L', 'L', 'L', 'M', 'L', 'L', 'M', 'M', 'M',
                    'H', 'M', 'M', 'L', 'H', 'M', 'M', 'M', 'H', 'H', 'H', 'M', 'M', 'H', 'L', 'M', 'H',
                    'M', 'M', 'M', 'H', 'M', 'M', 'M', 'H', 'M', 'M', 'M', 'L', 'L', 'M', 'L', 'H', 'L', 'H', 'M', 'M',
                    'L', 'L', 'M', 'M', 'L', 'L', 'L', 'M', 'M', 'L', 'M', 'M', 'M', 'M', 'H', 'L', 'L', 'L', 'M', 'M',
                    'L', 'H', 'L', 'M', 'M', 'M', 'M']}

        dev_info = client_type_dict[self.global_rounds]

        logging.info("client_configurations= %s" % str(dev_info))
    ...
    def plot(self, loss_list, acc_list,count_list):
        ...
        lst = np.arange(0, self.global_rounds+1, ((self.global_rounds-1) / 10))
        median_data = []
        ...
        plt.legend(
            title="Total clients={}\nClients per round=10\nMode=Non-Clustering (5:3:1)\nMethod=Uniform-random".format(
                self.client_total))
        plt.grid()
        plt.show()
