...
class FedAvgAPI(object):
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            client_indexes = self._client_sampling(
                round_idx,self.client_total, self.args.client_num_per_round   #needs to be modified for total and round client numbers
            )
            ...
            for device_type in client_indexes:
                if len(device_type)==0:
                    ...
                    for client_idx in device_type:
                        ...
                        for i in range(dev_epoch[device_type_idx]):
    ...
    def _client_sampling(self, round_idx, client_num_in_total, client_num_per_round):
        ...
        if client_num_in_total == client_num_per_round:
            ...
            self.counter+=1
            #client_indexes=random.sample(range(100), num_clients)
    ...
    def plot(self, loss_list, acc_list,count_list):
        ...
        plt.title("Frequency of client selection Clustering-All R.R.")
        plt.grid()
        plt.show()
