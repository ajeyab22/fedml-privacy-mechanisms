...
class FedMLAggregator(object):
    ...
    def data_silo_selection(self, round_idx, client_num_in_total, client_num_per_round):
        ...
        if client_num_in_total == client_num_per_round:
            ...
            data_silo_index_list = np.random.choice(client_num_in_total, client_num_per_round, replace=False)
            #logging.info("Client total = %s" %str(client_num_in_total))
            #logging.info("Selected client indices = %s" %str(data_silo_index_list))
    ...
    def client_selection(self, round_idx, client_id_list_in_total, client_num_per_round):
        ...
        logging.info("Client total = %s" %str(client_id_list_in_total))
        logging.info("Selected client = %s" %str(client_id_list_in_this_round))
        return client_id_list_in_this_round

    def client_sampling(self, round_idx, client_num_in_total, client_num_per_round):
        if client_num_in_total == client_num_per_round:
            client_indexes = [client_index for client_index in range(client_num_in_total)]
            #logging.info("Numbber of clients akshat = %s" % str(client_num_in_total))
        else:
